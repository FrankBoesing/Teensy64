...
uint8_t ret;
	...
	switch (address) {
		case 0x00: {ret = joystick2();};break;
		case 0x01: {ret = keypress();};break;
...
void cia1_checkRTCAlarm() { // call every 1/10 sec minimum
...
void resetCia1(void) {
	...
	cpu.cia1.R[0x04] = 0xff;
	cpu.cia1.R[0x05] = 0xff;
	cpu.cia1.R[0x06] = 0xff;
	cpu.cia1.R[0x07] = 0xff;
}
